...
- **🐦 官方资讯拉取**：Nitter RSS 轮询推送 X/Twitter 官方账号（@LimbusCompany_B）新推；**视频推文自动解析真实 mp4**（syndication API，1080p，分开发送）；RT 过滤、链接清洗、首启水位线防刷屏；**官方自回帖合并**（P38）：账号回复自己的线程续写/补充更正随父推文一并转发
...
| `/最新推文 [N]` | 拉取官方最新 N 条推文（含图片/视频与官方回复，N 默认 3 最多 5） |
